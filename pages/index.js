    ...
    <>
      ...
      <div className="page">
        ...
        <section className="network">
            ...
            <div className="network__bg-decor">
                <div className="network__bg-wrap">
                    <img class="network__bg-word" src="./img/networking/Unionconf_back.png" />
                </div>
                <img class="network__bg-cover" src="./img/networking/cover.png" />
            </div>
        </section>
                    ...
                    <div class="container">
                        ...
                        <div className="scale__card-row">
                                <div className="scale-card-wrapper">
                                    <div className="scale-card scale-card--pt">
